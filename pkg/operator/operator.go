/*
SPDX-FileCopyrightText: 2026 SAP SE or an SAP affiliate company and reactivejob-operator-cop contributors
...
import (
	...
	operatorv1alpha1 "github.com/sap/reactivejob-operator-cop/api/v1alpha1"
	"github.com/sap/reactivejob-operator-cop/internal/transformer"
)

const Name = "reactivejob-operator-cop.cs.sap.com"
...
func (o *Operator) Setup(mgr ctrl.Manager) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.ReactiveJobOperator](
		o.options.Name,
		resourceGenerator,
